...
public class MyBottomSheetDialog extends AppCompatDialog {
    ...
    private View view;
    public boolean mIsBackGroudTransparent = false;
    ...
    public void setContentView(@LayoutRes int layoutResId) {
        view = wrapInBottomSheet(layoutResId, null, null);
    ...
    public void setmBottomSheetCallback(BottomSheetBehavior.BottomSheetCallback mBottomSheetCallback) {
        this.mBottomSheetCallback = mBottomSheetCallback;
        mBehavior.setBottomSheetCallback(mBottomSheetCallback);
    }

    public void setScrollView(View view){
        System.out.println("叮铛铛咚咚铛铛多" + (onGlobalLayoutListener.getView() != view));
        if (onGlobalLayoutListener.getView() != view){
            onGlobalLayoutListener.setView(view);
            onGlobalLayoutListener.onGlobalLayout();
        }
    }

    private final MyOnGlobalLayoutListener onGlobalLayoutListener = new MyOnGlobalLayoutListener();
    ...
    private class MyOnGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
         ...
         */
        private void updateBehavior(View list) {
            ...
            if (list != null) {
                try {
                    ...
                    if (field != null) {
                        ...
                        field.set(mBehavior, new WeakReference<>(list));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public MyBottomSheetDialog showDialog() {
        show();
        return this;
    }
