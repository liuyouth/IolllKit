 ...
 */
open class IntegerViewBinder(itemClick: ItemClick<Integer, ViewHolder>) :
    BaseClickItemViewBinder<Integer, IntegerViewBinder.ViewHolder>(itemClick) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, string: Integer) {
